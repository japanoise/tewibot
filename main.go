...
func init() {
	...
	addCommand(addRevComfort, "Adds a custom reverse comfort. Syntax: &addcustomrcomfort [waifu name] COMFORT [comfort text]", "addcustomrcomfort", "addrcomfort")
	addCommand(customRevComfort, "Get given waifu to do a custom reverse comfort", "customrcomfort", "ccrcomfort")
	addCommand(addComfort, "Adds a custom comfort. Syntax: &addcustomcomfort [waifu name] COMFORT [comfort text]", "addcustomcomfort", "addcomfort")
	addCommand(customComfort, "Get given waifu to do a custom comfort", "customcomfort", "cccomfort")
